...
sns.heatmap(datausedmatrix, vmin=0)
...
data = pd.read_csv("/Users/karlyjae/Documents/25-spring-kiriarte/datasets/maryland_trail_accessibility_by_county.csv")
...
folium.Choropleth(
            ...
            name="choropleth",
            data=data,
            columns=["name_right", "accessibility_score"],
